      ...
      <div className="relative" ref={menuRef}>
        <div className="relative">
          <button
            ...
            type="button"
            className="bg-primary text-fourth inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg hover:bg-rose-950 2xl:hidden"
          ...
          <nav
            ...
            ${menuOpen ? "" : "hidden"}`}
          >
            <ul className="text-fourth text-3xl h-screen text-start bg-primary font-semibold tracking-wider space-y-5 py-5">
              <div className="flex justify-between px-5 py-2 items-center h-auto text-white ">

                {/* CLOSING SVG */}

                <div className="text-xl">Italiano</div>
              ...
              <div className="flex flex-col items-start h-full space-y-5">
                <button className="w-auto mx-5 h-10 hover:bg-white">
                  <li className="hover:text-black">Il nostro menu</li>
                </button>
                <button className="w-auto mx-5 h-10 hover:bg-white">
                  <li className="hover:text-black">Ordinare</li>
                </button>
                <button className="w-auto mx-5 h-10 hover:bg-white">
                  <li className="hover:text-black">Prenotare</li>
                </button>
                <button className="w-auto mx-5 h-10 hover:bg-white">
                  <li className="hover:text-black">Galleria</li>
                </button>
                <button className="w-auto mx-5 h-10 hover:bg-white">
                  <li className="hover:text-black">Contatti</li>
                </button>
