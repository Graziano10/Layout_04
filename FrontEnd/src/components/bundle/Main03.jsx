      ...
      <div className="bg-secondary">
        <div className="h-full relative z-10 block x:hidden">
          <div
            ...
            data-carousel="slide"
          >
            <h1 className="text-black font-semibold text-center text-3xl md:text-5xl x:text-2xl">
              Payment methods
            </h1>
            ...
            <button
              type="button"
              className="absolute top-[50%] left-[0%] z-30 h-auto px-4 cursor-pointer x:left-[1%]"
              data-carousel-prev
            ...
            <button
              type="button"
              className="absolute top-[50%] right-[0%] z-30 h-auto px-4 cursor-pointer bg-trasparent x:right-[1%]"
              data-carousel-next
        ...
        <div className="hidden x:block">
          <div className="h-full flex justify-center items-center">
            {" "}
            <h1 className="text-fourth font-semibold text-center text-3xl md:text-5xl x:text-6xl mt-5">
              Payment methods
            </h1>
          </div>
